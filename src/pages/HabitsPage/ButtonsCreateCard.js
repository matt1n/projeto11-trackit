...
export default function ButtonsCreateCard({
  u,
  i,
  selectedDays,
  setSelectedDays,
...
const ButtonUnselected = styled.button`
  ...
  border: 1px solid
    ${(props) =>
      props.buttonSelect ? props.selected.border : props.unselected.border};
  font-family: "Lexend Deca";
  font-size: 20px;
  color: ${(props) =>
    props.buttonSelect ? props.selected.color : props.unselected.color};
  border-radius: 5px;
  margin-right: 4px;
`;
